...
export default function WebsiteSettings() {
    ...
    const [websiteErrors, setWebsiteErrors] =
        useState<FormErrors>({});

    const [isSavingWebsite, setIsSavingWebsite] =
    ...
    const handleLogoChange = (
        ...
        if (!allowedTypes.includes(file.type)) {
            setWebsiteErrors((previous) => ({
                ...previous,
                logo:
                    "Only PNG, JPG, JPEG, WEBP, or SVG images are allowed.",
            }));
    ...
    const validateWebsiteSettings = (): boolean => {
         ...
         * LOGO
         *
         * Require either an existing logo URL or
        ...
        if (websiteSettings.facebookUrl.trim()) {
            if (
                !isValidSocialUrl(
        ...
        if (websiteSettings.instagramUrl.trim()) {
            if (
                !isValidSocialUrl(
        ...
        if (
            websiteSettings.whatsappUrl.trim() &&
            !isValidUrl(
         ...
         * WHATSAPP MESSAGE
         *
         * If WhatsApp URL exists, message becomes required.
         */
        if (websiteSettings.whatsappUrl.trim()) {
            const message =
                websiteSettings.whatsappMessage.trim();

            if (!message) {
                errors.whatsappMessage =
                    "WhatsApp message is required when WhatsApp is enabled.";
            }
            if (message.length < 5) {
                errors.whatsappMessage =
                    "WhatsApp message must contain at least 5 characters.";
            }
            if (message.length > 500) {
                errors.whatsappMessage =
                    "WhatsApp message cannot exceed 500 characters.";
            }
        }

        /* EMAIL */

        if (!websiteSettings.email.trim()) {
            errors.email =
    ...
    const handleSaveWebsiteSettings =
        async (): Promise<void> => {
            ...
            try {
                /*
                 * Replace with Firebase / Cloudinary upload.
                 */
    ...
    const openAddLocation = (): void => {
        ...
        setLocationForm({
            ...EMPTY_LOCATION_FORM,
            openingHours: [
                ...EMPTY_LOCATION_FORM.openingHours,
            ],
        });
    ...
    const validateLocation = (): boolean => {
        ...
        if (!name) {
            ...
            errors.name =
                "Location name cannot exceed 80 characters.";
        }
        ...
        if (
            ...
            errors.openingHours =
                "Add at least one opening-hours entry.";
        }
                    ...
                    <div className="space-y-6 p-5 lg:p-6">
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div
                                    className={`flex h-11 w-full overflow-hidden rounded-lg border bg-transparent text-sm transition ${websiteErrors.whatsappUrl
                        ...
                        >
                            <textarea
                                ...
                                maxLength={500}
                                value={
                                    websiteSettings.whatsappMessage
                                }
                                onChange={(event) =>
                                    setWebsiteSettings(
                                        (previous) => ({
                ...
                <div className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
                    ...
                    <div className="mt-6">
                        <div className="mb-3">
                            ...
                            <p className="mt-1 text-xs text-gray-400">
                                Enter the opening hours exactly
...
function Field({
    ...
    return (
        <div className="min-w-0">
            ...
            {error && (
                <p className="mt-1 break-words text-xs text-error-500">
                    {error}
                </p>
            )}
        </div>
...
const valueClass =
    "mt-1 break-words text-sm text-gray-700 dark:text-gray-300";
